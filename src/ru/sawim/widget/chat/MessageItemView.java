...
public class MessageItemView extends View {
    ...
    public MessageItemView(Context context) {
        super(context);
        System.out.println("message item constructor");
    ...
    public void draw(Canvas canvas) {
        ...
        if (layout != null) {
            ...
            canvas.translate(getPaddingLeft(), y);
            layout.draw(canvas);
            canvas.restore();
        }
        //FIXME жуткий костыль. и мне реально стыдно за него :( но сходу прикрутить анимацию не смог. hs_sergey
