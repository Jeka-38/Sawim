...
//            }
            //уменьшаем аватарку до 480х  сохраняем как джипег со качеством 50
            ...
            System.out.println("outWidth = " + o.outWidth + "  outHeight = " + o.outHeight);
            ...
            byte[] binAvatar = out.toByteArray();
