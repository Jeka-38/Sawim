...
public class ChatView extends SawimFragment implements OnUpdateChat, Handler.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        messageEditor.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
//        if(Emotions.instance.isAniSmiles()) {
//            AniImageList images = (AniImageList)Emotions.instance.getImages();
//            for(int i=0; i<images.size(); ++i) {
//                AniIcon icon = (AniIcon)images.iconAt(i);
//                DrawableCallback drawableCallback = icon.getDrawableCallback();
//                drawableCallback.addView(messageEditor);
//            }
//        }
    ...
    private void destroyMultiCitation() {
        ...
        getMessagesAdapter().setMultiQuote(false);
    ...
    private ListView.OnItemClickListener chatClick = new ListView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
            ...
            if (getMessagesAdapter().isMultiQuote()) {
    ...
    private MyMenu getMenu() {
        ...
        menu.add(getString(getMessagesAdapter().isMultiQuote() ?
        ...
        switch (id) {
            case ContactMenu.MENU_MULTI_CITATION:
                if (getMessagesAdapter().isMultiQuote()) {
                    ...
                    getMessagesAdapter().setMultiQuote(true);
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (getMessagesAdapter() != null && getMessagesAdapter().isMultiQuote()) {
